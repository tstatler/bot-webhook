...
var config = {
  ...
  token:
    "ODFjMzk1ZDMtMTNmNi00YWNkLTk3ODUtYjIyM2I1NzI0MTBmMWU5OGE3MzctODI1_PF84_1eb65fdf-9643-417f-9974-ad72cae0e10f",
...
framework.hears("hello", function (bot, trigger) {
  ...
  bot.reply("Hello %s!", trigger.person.displayName);
  responded = true;
});

framework.hears("goodbye", function (bot, trigger) {
  // bot.say('Good bye %s!', trigger.person.displayName);
  bot.reply("Good bye %s!", trigger.person.displayName);
  responded = true;
});
